...
public class AuthenticationService {
    ...
    public ResponseEntity<?> authenticate(LoginUserDto input) {
        try {
            System.out.println("new login attempt...."+ input.getEmail());
            ...
            extractClaims.put("userName",user.getName());

            String token = jwtService.generateToken(extractClaims,user);
    ...
    public ResponseEntity<?> resendVerificationCode(String email) {
        ...
        User user = userRepository.findByEmail(email)
                .orElseThrow(() -> new IllegalArgumentException("We couldn’t find an account associated with this email. " + email));
