...
const RegisterPage = () => {
  ...
  const handleRegister = async () => {
    const { username, email, phone, password, confirmPassword, accountType } = formData;
          ...
          <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
            ...
            <View style={{ marginBottom: 20 }}>
              ...
              <Animated.View style={getInputContainerStyle('phone')}>
                ...
                <TextInput
                  ...
                  onSubmitEditing = {()=>inputRefs.current.accountType.focus()}
                />
              </Animated.View>
            </View>
            ...
            <View style={{ marginBottom: 20 }}>
              ...
              <View style={{ position: 'relative' }}>
                <TouchableOpacity
                    ref={(ref)=>inputRefs.current.accountType = ref}
                ...
                >
                  <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ 
                      ...
                      {formData.accountType === 'seeker' ? 'Job Seeker' : 'Job Poster'}
                    </Text>
                  </View>
                  <Ionicons 
                    ...
                    {['seeker','poster'].map((opt) => (
                      <TouchableOpacity
                        ...
                        onPress={() => { 
                          ...
                          handleInputChange('accountType', opt); 
                        ...
                        style={{ 
                          ...
                          flexDirection: 'row', 
                          alignItems: 'center', 
                          backgroundColor: formData.accountType === opt ? '#f3f4f6' : '#ffffff',
                          borderBottomWidth: opt === 'seeker' ? 1 : 0,
                      ...
                      >
                        <Ionicons 
                          ...
                          size={20} 
                          color={formData.accountType === opt ? '#6366F1' : '#6b7280'} 
                        />
                        <Text style={{ 
                          marginLeft: 12, 
                          fontSize: 15, 
                          color: formData.accountType === opt ? '#6366F1' : '#374151', 
                          fontWeight: formData.accountType === opt ? '700' : '500' 
                        }}>
